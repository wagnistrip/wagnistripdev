...
class PNR_AddMultiElements extends Controller
{


    public function PNR_AddMultiElements(Request $request , $tnxid ,$showprice)
    {
        ...
        $bookingData = Booking::where('logs_id', $tnxid)->first();
                        ...
                        if ($pnrRetrieve->status === Result::STATUS_OK) {
                            ...
                            // if ($issueTicketResponse->status === Result::STATUS_OK) {
                                ...
                                // if ($pnrRetrieveAndDisplay->status === Result::STATUS_OK) {
                                    ...
                                    $saveBooking->fare = json_encode($FareInformationA, true);

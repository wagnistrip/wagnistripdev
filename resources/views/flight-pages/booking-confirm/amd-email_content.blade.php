    ...
    <main>
        <table class="vikas" style="max-width: 650px;">
            <tr>
                ...
                @endphp
                <tr style="background-color: #18a160;padding: 5px 18px;border-top-left-radius: 10px;border-top-right-radius: 10px;margin-top: 10px;">
                    <td colspan="4" style="border: none;">
                        ...
                        <!--        fill="#FCA800" />-->
                        <!--</svg>-->
                    <!--<img src="{{url('assets/images/flight/mailImg/IMG.png')}}" />-->
                    <!--<img src="https://img.icons8.com/clouds/100/000000/handshake.png" width="125" height="120" style="border: 0px;" />-->
                    <!--</td>-->
                    <!--<td colspan="2" style="border: none;">-->
                        ...
                        <p style="color:#fff; text-align: center;margin-right: 10px;">
                        {{ AirportiatacodesController::getCity($fristcity) }} - {{ AirportiatacodesController::getCity($lastcity) }} flight is confirmed
                        </p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="justify-content: space-around;align-content: stretch;justify-items: end;display: flex;flex-direction: row;flex-wrap: wrap;gap: 10px;">
                ...
                <tr style="background: #1951b5;line-height: 15px;width: 100%;border-radius: 12px;margin-top: 25px;">
                    ...
                    <td colspan="2" style="text-align: center; padding-top: 10px;">
                        {{ AirportiatacodesController::getCity($fristcity) }} TO {{ AirportiatacodesController::getCity($lastcity) }}
                ...
                <tr >
                    ...
                    <td class="gorakhpur-details" style="text-align: center;" >
                        <h2 style="font-weight: bold;color: #eb6125; width: 200px;">{{$itinerary->DepartCityName}}</h2>
                    ...
                    bottom: 25px;">{{  getDate_fn($itinerary->DepartDate) ?? date('d-m-Y', strtotime($itinerary->DepartDate)) }} | {{ date('H:i', strtotime($itinerary->DepartDateTime)) }}</p>
                        <p style="text-align: center;font-size: 12px;position: relative;bottom: 35px;">Airport : {{ $itinerary->DepartAirportName }}</p>
                    </td>
                    <td class="timing" style="margin-top: 35px;position: relative;left: 30px;">
                        <img style="width:16px;margin-left: 15px;" src="{{asset('assets/images/images/watch.png')}}" alt="time">
                        <p class="timingpara" style="color: #000;position: relative;left:8px; bottom: 12px;">{{ getTime_fn($itinerary->Duration) }}</p>
                        
                        <hr class="timinghr"style="color: #ddd;width: 50px;margin-right: 110px;position: relative;bottom: 20px;">
                        
                        <p style="color: #000;position: relative;bottom: 30px;">Economy: {{ $itinerary->TravelClass }}</p>
                    </td>
                    ...
                    bottom: 25px;">{{ getDate_fn($itinerary->ArrivalDate)??date('d-m-Y', strtotime($itinerary->ArrivalDate)) }} | {{ date('H:i', strtotime($itinerary->ArrivalDateTime)) }}</p>
                        <p style="text-align: center;font-size: 12px;position: relative;bottom: 35px;">Airport : {{ $itinerary->ArrivalAirportName }}</p>
                    </td>
                </tr>
                
                @endforeach
                <tr class="passenger-name"
                    style="background: #eef4fd;border-radius: 8px;color: #1951b5;">
                    ...
                    @endphp
                    <tr>
                        <td style="padding: 10px 5px;vertical-align: top;font-family: arial;text-align: center;font-size: 12px; border-right: solid 1px #f4f4f4;color: #4a4a4a;width: 25%;">
                            {{$key+1}} . {{ $passenger->Title . ' ' . $passenger->FirstName . ' ' . $passenger->LastName }} , ({{ $passenger->PaxTypeCode }})
                        </td>
                ...
                <tr>
                <td colspan="4">
                    <p style="font-size: 12px;padding: 0px 5px;"><strong>1. Web Check-in :</strong> Web Check-in is now a
                    ...
                    <p style="font-size: 12px;padding: 0px 5px;margin-top: 15px;"><strong>5. Gosafe-certified Airport Cabs
                ...
                <tr  class="baggage-info" style="text-align: center;padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                    <td colspan="4" >
                ...
                <tr>
                    ...
                    <tr>
                     ...
                     @endforeach
                <tr class="payment-info" style="text-align: center; padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                    <th colspan="4">
                ...
                <tr style="text-align: center;">
                    <td colspan="4">
                        <p>You have Paid INR {{ $fare[0]->PaxBaseFare??'' }} {{-- | For Fare Breakup <a href="">Get Invoice</a>--}}</p>
                    </td>
                </tr>
                <tr class="cancellation" style="text-align: center; padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                    <td colspan="4">
                ...
                <tr>
                    <td colspan="4" style="padding:5px 0px 5px 10px;vertical-align:top;font-family:arial;background:#eef4fd;font-weight:bold;line-height:12px;font-size:12px;color:#1951b5">

        ...
        <div class="containing p-0">
            <div class="card-body">
                ...
                {{--<a class="btn float-right btn-sm"
                    href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2023).'/3' }}">
            ...
            <div class="card border-dotted mb-3 p-3">
                ...
                @endphp 
                    <p class="m-0 small"><span>(Hand Baggage) {{$baggage[0]->CheckIn ?? ''}}</span> </p>
                    <p class="m-0 small"><span class="font-weight-bold">(Check-in Baggage){{$baggage[0]->CabIn ?? ''}}</span>
                </p>

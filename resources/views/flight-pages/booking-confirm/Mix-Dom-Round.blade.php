     ...
     <div class="ntainer p-0">
            <div class="card-body">
                ...
                {{-- <a class="btn float-right btn-sm"
                    href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2023).'/1' }}">
                ...
                <a class="btn float-right btn-sm" onclick="downloadPDF()">
                 ...
                 <div class="download-button">
                    ...
                    <p class="h3 text-success">Please save this ticket first.</p>
                </div>
            </div>
            <div id="main-content">
            <br>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border-right text-center">
                                    ...
                                    <h6 class="small m-0">{{   getDateFormat_db($itinerary->DepartDateTime)  }} | <strong>{{  getTimeFormat_db($itinerary->DepartDateTime)  }}</strong> </h6>
                        ...
                        <table class="table border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right">Rs: {{ ((int)$fare) + ((int)$fare2[0]->PaxBaseFare ?? 0)   ?? '' }}</td>
                                </tr>
                                {{-- <tr>
                                    <td>Total Other Tax</td>
                                    <td class="text-right">Rs: {{ ( ( ( (int)$fare->TotalOtherTax + (int)$fare2[0]->PaxTotalFare )?? 0 ) - ( (int)$fare->TotalBaseFare + (int)$fare2[0]->PaxBaseFare  )?? 0) }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Total Fare</strong></td>
                                    <td class="text-right">Rs: {{ ( (int)$fare2[0]->PaxTotalFare ?? 0 ) }}</td>
                                </tr> --}}
                            </tbody>
                        </table>
                    </div>

        ...
        <div class="container p-0">
            <div class="card-body">
                ...
                {{--<a class="btn float-right btn-sm"
                    href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2023).'/2' }}">
                ...
                <div class="row">
                   ...
                   {{--  <div class="col-md-6">
                        <div class="card-body p-2 rounded-lg" style="background-color:#e74c3c;">
                            <h4 class="font-weight-bold m-0 text-white">FLAT 20% OFF On Domestic Flights</h4>
                        ...
                        <div class="col-md-12">
                            <div class="mb-1">
                                ...
                                @foreach (json_decode($bookings->itinerary) as $itinerary)
                                    {{ AirportiatacodesController::getCity($itinerary->DepartAirportCode) }} - 
                                @endforeach
                                @php
                                ...
                                @endphp
                                    ...
                                    {{ AirportiatacodesController::getCity($lastcity) }} is
            ...
            <div class="card border-dotted mb-3 p-3">
                ...
                @endphp 
                <p class="m-0 small"><span>(Hand Baggage)</span>{{$baggage[0]->CheckIn}}</p>
                <p class="m-0 small"><span class="font-weight-bold">(Check-in Baggage) {{$baggage[0]->CabIn}}</span></p>
                        ...
                        <table class="table border">
                            ...
                            <tbody>
                               {{-- <tr>
                                    ...
                                    <td class="text-right">Rs: {{ abs(((int) $fare->PaxBaseFare ?? 0) *$numberOfTra - ((int)$fare->PaxTotalFare ?? 0) * $numberOfTra) }}</td>
                                </tr>
                                <tr>
                                    <td>Total Other Tax</td>
                                    <td class="text-right">Rs: {{ ((int)$fare->PaxTotalFare ?? 0) * $numberOfTra }} </td>
                                </tr> --}}
                                <tr>
                                    <td><strong>Total Fare</strong></td>
                                    <td class="text-right">Rs: {{((int) $fare->PaxTotalFare ?? 0) }}</td>
                                </tr>
                            </tbody>
                            @endforeach
                        </table>

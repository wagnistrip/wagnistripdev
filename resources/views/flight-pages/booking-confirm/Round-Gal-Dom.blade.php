...
@section('body')
@php
        $bookings2 = $bookings['FristpnrRetrieve'];
...
@endphp
        ...
        <div class="container p-0">
            <div class="card-body">
                ...
                {{--<a class="btn float-right btn-sm"
                    href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2023).'/5' }}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h5 class="m-0">Wagnistrip Booking ID: <strong> {{ $bookings->booking_id }}</strong></h5>
                        <p>
                            <small>
                                <strong>Booking Date:-{{  date('d-m-Y', strtotime($bookings->created_at)) }} </strong> {{-- | <strong>Booking
                                Time:- {{ date("H:i",strtotime($bookings->created_at)) }}</strong> --}}
                        ...
                        <div class="col-md-12">
                            <div class="mb-1">
                                <p><i class="fa fa-check-circle text-success" aria-hidden="true"
                                        style="font-size:30px;"></i> Your Flight Ticket for {{ $itinerary->DepartCityName }} to {{ $itinerary->ArrivalCityName }} is
            ...
            <div class="card p-2 mb-3">
                <table class="table">
                            ...
                            @if ($bookings->trip_type == 2)
                                ...
                                @if (isset($OutboundItinerays[3]) && !isset($OutboundItinerays[4]))
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $OutboundItinerays[0]->AirLineName }} | {{ $bookings->gds_pnr }}</td>
                            ...
                            @elseif($bookings->trip_type == 1)
                                ...
                                @elseif (isset($itinerarys[1]) &&
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $itinerarys[0]->AirLineName }}  {{ $bookings->gds_pnr }}</td>
                    ...
                    <tbody>
                        @php
                            $itinerarys = json_decode($bookings2->itinerary);
                        @endphp
    ...
    <div class="card border-dotted mb-3 p-3">
                <h6 class="m-0 font-weight-bold">Baggage Details:</h6>
                    ...
                    <p class="m-0 small"><span class="font-weight-bold">(Check-in Baggage)7KG</span></p>

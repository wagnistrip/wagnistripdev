        ...
        <div class="container p-0">
            <table id="main-content">
                ...
                @endphp
                    <td colspan="6" style="padding:10px;">
                        <h4>E-Ticket</h4>
                        <h5 style="margin-top: -14px;">Wagnistrip Booking ID: <strong>{{ $bookings->booking_id }}</strong>
                        </h5>
                ...
                <tr style="text-align:center;">
                    ...
                    <td style="border-right: 1px solid #d3d3d3d4;border-bottom: 1px solid #d3d3d3d4; font-size: 17.7px;">
                        ...
                        <h6 style="margin-top: -16px;">{{   getDateFormat_db($itinerary->DepartDateTime)  }} | <strong>{{  getTimeFormat_db($itinerary->DepartDateTime)  }}</strong> </h6>
                ...
                <tr >
                    <td colspan="6" style="font-size: 16px; text-align: left; padding: 5px; background: #d3d3d354;">
                        <h6 style="font-size:20px;">Baggage Details for:</h6>
                        <h6 style="font-size:20px;"> {{ AirportiatacodesController::getCity($fristcity) }} to {{ AirportiatacodesController::getCity($lastcity) }} </h6>
                ...
                <tr >
                    <td colspan="6" style="font-size: 16px; text-align: left; padding: 5px; background: #d3d3d354;">
                        <h6 style="font-size:20px;">Baggage Details for:</h6>
                        <h6 style="font-size:20px;">{{ AirportiatacodesController::getCity($lastcity) }} to {{ AirportiatacodesController::getCity($fristcity) }}</h6>
                        <p style="margin-top: -37px;"><span>(Hand Baggage)</span> {{$baggage2[0]->CheckIn}} </p>
                        <p ><span class="font-weight-bold">(Check-in Baggage) {{$baggage2[0]->CabIn}}</span>
                        </p>
                    </td>
                </tr>
                @endif
            ...
            <!-- Contact Information Starts -->
                ...
                {{--<tr>
                    ...
                    <td colspan="3" style="border-bottom: 1px solid #cbc9c994;">Rs: {{ ((int)$fare->TotalBaseFare??0) + ((int)$fare2[0]->PaxBaseFare ?? 0)   ?? '' }}</td>
                </tr>
                <tr>
                    <td colspan="3" style="border-bottom: 1px solid #cbc9c994;">Total Other Tax</td>
                    <td colspan="3" style="border-bottom: 1px solid #cbc9c994;">Rs: {{ ( ( ( (int)$fare->TotalOtherTax + (int)$fare2[0]->PaxTotalFare )?? 0 ) - ( (int)$fare->TotalBaseFare + (int)$fare2[0]->PaxBaseFare  )?? 0) }}</td>
                </tr> --}}
                <tr>
                    <td colspan="3" style="font-size: 16px; text-align: left; padding: 5px; background: #d3d3d354;"><strong>Total Fare</strong></td>
                    <td colspan="3" style="font-size: 16px; text-align: left; background: #d3d3d354;">Rs: {{ ($fare2[0]->PaxTotalFare ?? '') }}</td>
                </tr>

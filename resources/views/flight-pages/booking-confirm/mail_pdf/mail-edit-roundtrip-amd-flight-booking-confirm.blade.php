...
<body style="background-color:#fff !important;margin-top:100px;">
    <div class="container p-0">
        <div class="card-body">
            {{-- <a class="btn float-left btn-sm" href="{{ url('user/amadeus') }}">
        ...
        <div class="d-flex bd-highlight mt-3 mb-3" style="border-bottom:1px solid #0065a5;">
            ...
            <div class="ml-auto p-2 bd-highlight">
                ...
                <p>
                            ...
                            <small><strong>Booking Date:-{{ $FristpnrRetrieve->response->pnrHeader->reservationInfo->reservation->date }}
                                </strong> | <strong>Booking
                            Time:- {{ date('H:i', strtotime( $FristpnrRetrieve->response->pnrHeader->reservationInfo->reservation->time )) }}</strong> </small>
                </p>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h5 class="m-0">Wagnistrip Booking ID: <strong>WT000{{ $pnrRetrieve->response->pnrHeader->reservationInfo->reservation->controlNumber }}{{ $FristpnrRetrieve->response->pnrHeader->reservationInfo->reservation->controlNumber }}</strong>
                    </h5>
                    <p>
                             <small><strong>Booking Date:-{{ $FristpnrRetrieve->response->pnrHeader->reservationInfo->reservation->date }}
                                </strong> | <strong>Booking
                            Time:- {{  ( $FristpnrRetrieve->response->pnrHeader->reservationInfo->reservation->time ) }}</strong> </small>
                    </p>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="mb-1">
                            <p><i class="fa fa-check-circle text-success" aria-hidden="true"
                                ...
                                {{ $FristpnrRetrieve->response->securityInformation->cityCode }} to {{ $FristpnrRetrieve->response->securityInformation->cityCode }} is
                        ...
                        <tr>
                            <th class="border-right text-center" scope="row">
                               {{-- <img src="{{ asset('assets/images/flight/' . $itinerary->AirLineCode) }}.png" 
                                    alt="{{  }}">
                                <h6 class="small m-0">UK</h6>
                                <p class="small font-weight-bold m-0">
                                    itinerary->AirLineCode . '-' itinerary->FlightNumber </p> --}}
                                    
                                    <img src="{{ asset('assets/images/flight/' . $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->companyId) }}.png"
                                  {{--  <img src="{{ asset('assets/images/flight/' . $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->controlNumber) }}.png"--}}
                                    alt="{{ $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->companyId}}">
                                <h6 class="small m-0">UK</h6>
                                <p class="small font-weight-bold m-0">
                                    {{ $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->companyId}} . '-' {{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->travelProduct->companyDetail->identification}}
                            </th>
                            <td class="border-right text-center">
                                <h5 class="m-0">{{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->travelProduct->offpointDetail->cityCode}} </h5>
                                <h6 class="small m-0">{{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->flightDetail->departureInformation->departTerminal}} </h6>
                                <h6 class="small m-0"> ({{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->legInfo->legTravelProduct->flightDate->departureDate}})
                                    |
                                    <strong> ({{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->legInfo->legTravelProduct->flightDate->departureTime}})
                                </h6>
                            ...
                            <td class="border-right text-center">
                                ...
                                <h6 class="small m-0">
                                    <strong> ({{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->legInfo->legTravelProduct->flightDate->arrivalDate}})  |
                                         ({{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->legInfo->legTravelProduct->flightDate->arrivalDate}}) </strong>
                                </h6>
                                <p class="small m-0"> {{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->travelProduct->offpointDetail->cityCode}} </p>
                            </td>
                            {{--
                            <td class=" text-center">
                                <h6 class="small m-0">Economy :  {{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->travelProduct->productDetails->classOfService}} </h6>
                                <h6 class="small m-0">Flight :  0stop  </h6>
                                <h6 class="small m-0">Duration:  {{$FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->flightDetail->productDetails->duration}}  | Aviation</h6>
            ...
            <table class="table">
                ...
                <tbody>
                        ...
                        <tr style="text-align:center;">
                            <td scope="col">
                                 Mr {{$FristpnrRetrieve->response->travellerInfo->passengerData->travellerInformation->passenger->firstName}} {{$FristpnrRetrieve->response->travellerInfo->passengerData->travellerInformation->traveller->surname}}
                            ...
                            <td scope="col">
                              {{ $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->controlNumber}}
                            </td>
                            <td scope="col">
                                 {{ $FristpnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->controlNumber}}
                            </td>
                        ...
                        <tr style="text-align:center;">
                            ...
                            <td scope="col">
                              {{ $pnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->controlNumber}}
                            </td>
                            <td scope="col">
                                 {{ $pnrRetrieve->response->originDestinationDetails->itineraryInfo[1]->itineraryReservationInfo->reservation->controlNumber}}
                            </td>
                    ...
                    <table class="table border">
                        ...
                        <tbody>
                            <tr style="line-height:10px;">
                                <td>Customer Name:-</td>
                                <td> Mr {{$FristpnrRetrieve->response->travellerInfo->passengerData->travellerInformation->passenger->firstName}} {{$FristpnrRetrieve->response->travellerInfo->passengerData->travellerInformation->traveller->surname}}
                                </td>
                            </tr>
                            <tr style="line-height:10px;">
                                <td>Mobile:-</td>
                    ...
                    <table class="table border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-right">Rs: {{ $fare->PaxOtherTax }}</td> --}}
                            </tr>
                            <tr>

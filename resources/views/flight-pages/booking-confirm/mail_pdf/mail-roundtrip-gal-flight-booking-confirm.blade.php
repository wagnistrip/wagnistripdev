    ...
    <body style="background-color:#fff !important;margin-top:100px;">
        ...
        <div class="container p-0">
            <div class="card-body">
                ...
                <a class="btn float-right btn-sm" href="{{ URL::to('/booking-pdf/flight-booking/' . $bookings->id * 2021) }}">
                ...
                <div class="ml-auto p-2 bd-highlight">
                    ...
                    <p>
                        @foreach(json_decode($bookings->itinerary) as $itinerary)
                            ...
                            <small><strong>Booking Date:-{{  date('d-m-Y', strtotime($bookings->created_at)) }} </strong> | <strong>Booking
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>@foreach(json_decode($bookings->itinerary) as $itinerary)
                            <small><strong>Booking Date:- </strong>{{  date('d-m-Y', strtotime($bookings->created_at)) }} | <strong>Booking
                                @foreach(json_decode($bookings->passenger) as $passenger)   
                                Time:- </strong> {{ date("H:i",strtotime($passenger->IssueDate)) }}
                                @endforeach
                            </small>
                          @endforeach</p>
                    </div>

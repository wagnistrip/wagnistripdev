            ...
            <div class="containing"
                ...
                <div class="logoAndBookingId">
                    <div class="grid grid-two-column"
                        style="display: grid;gap: 52%;grid-template-columns: repeat(2, 1fr);">
                ...
                <p class="web-check-in-para" style="text-align: center;color: #647a97;font-weight: 900;">Web check-in is
                    mandatory & can be done
                    in 2-steps with us.</p>
                <div class="check-inAndBooking">
                    <div class="grid grid-two-column"
                        ...
                        <a href="https://flights.wagnistrip.com/web-check-in" style="background-color: rgb(255, 109, 56);text-decoration: none;color: #fff;padding: 12px 30px;width:200px;
                ...
                <div class="destination"
                    style="background: #1951b5;line-height: 15px;width: 100%;border-radius: 12px;margin-top: 25px;">
                    <div class="grid grid-three-column"
                        style="display: flex;flex-direction: row;justify-content: space-around;">
                        <div class="date">
                            <p style="color: #fff;text-align: center;">WED, 09 DEC '20</p>
                        </div>
                        <div class="place" style="width:230px">
                ...
                @endphp 
                    ...
                    @foreach (json_decode($bookings->itinerary) as $itinerary)
                <div class="flight">
                    <div class="grid grid-four-column" style=" display: grid;grid-template-columns: repeat(4, 1fr);">
                        <div class="flight-img" style="margin-top: 20px;">
                           <img style="width:30px" src="{{ asset('assets/images/flight/' . $itinerary->AirLineCode) }}.png" alt="{{ $itinerary->AirLineCode }}">
                            <p class="indigo-airlines-para" style="font-size: 12px;">{{ $itinerary->AirLineName }}</p>
                            <p style="font-size: 12px;position: relative;bottom: 10px;">{{ $itinerary->AirLineCode . '-' . $itinerary->FlightNumber }}</p>
                        </div>
                        <div class="gorakhpur-details">
                        ...
                        <div class="timing" style="margin-top: 35px;position: relative;left: 30px;">
                            <img style="width:16px;margin-left: 15px;" src="{{asset('assets/Images/watch.png')}}" alt="time">
                            <p class="timingpara" style="color: #9b9b9b;position: relative;bottom: 12px;"></p>
                            <hr class="timinghr"
                                style="color: #9b9b9b;width: 50px;margin-right: 110px;position: relative;bottom: 20px;">
                            <p style="color: #9b9b9b;position: relative;bottom: 30px;">Economy: {{ $itinerary->TravelClass }}</p>
                        </div>
                        <div class="hyderabad-details">
                ...
                <div class="passenger-name"
                    style="padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;">
                    <div class="grid grid-four-column" style=" display: grid;grid-template-columns: repeat(4, 1fr);">
                        <p>PASSENGER NAME</p>
                ...
                <div class="baggage-info" style="padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                    <p>BAGGAGE INFORMATION</p>
                </div>
                <tr>
                    <td style="padding:20px 10px">
                        <table align="center" class="baggage-info-table" style="border-collapse: collapse;border-spacing: 0;width: 98%;border: 1px solid #f4f4f4;margin-bottom: 10px;
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding:10px 5px;vertical-align:top;font-family:arial;font-size:12px;text-align:center;color:#4a4a4a">
                                        {{$baggage[0]->CheckIn}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                </tr>
                <div class="payment-info" style="padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                ...
                <div class="cancellation" style="padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;
                    margin-left: 10px;">
                    <p>CANCELLATION AND DATE CHANGE CHARGES</p>
                </div>
                <p style="margin-left: 15px;">All charges below are per Pax and per Segment in INR</p>
                <div class="cancellation-info" style="position: relative;right: 20px;">
                    <div class="grid grid-two-column"
                        style="display: flex;flex-direction: column;flex-wrap: nowrap;align-content: center;justify-content: space-evenly;align-items: baseline;">
                        <table align="left" class="cancellation-table"
                            style="border-collapse:collapse;border-spacing:0;width:98%;border:1px solid #f4f4f4;margin-bottom:10px;margin-left: 30px;">
                            <tbody>
                        ...
                        <table align="right" class="date-change-table"
                            style="border-collapse:collapse;border-spacing:0;width:98%;border:1px solid #f4f4f4;margin-bottom:0px;margin-left: 30px;margin-top: 15px;">
                            <tbody>
                                <tr style="background:#eef4fd;font-weight:bold">
                                    <td colspan="2"
                                        style="padding:5px 10px;vertical-align:top;font-family:arial;text-align:left;border-bottom:1px solid #f4f4f4;font-size:11px;line-height:12px">
                ...
                <div class="customer-support"
                    style="padding: 5px 15px;background: #eef4fd;border-radius: 8px;color: #1951b5;margin-top: 20px;width: 93.5%;margin-left: 10px;">
                    <p>24x7 CUSTOMER SUPPORT</p>
                </div>
                <div class="support" style="margin-top: 20px;position: relative;right: 15px;">
                    <div class="grid grid-two-column" style="display: flex;flex-direction: row;flex-wrap: nowrap;align-content: center;
                    justify-content: space-evenly;align-items: baseline;">
                        <table class="wagnistrip-support-table" align="left"
                            style="border-collapse: collapse;border-spacing: 0;width: 40%;border: 1px solid #f4f4f4;padding: 5px;">
                            <tbody>
                                <tr>
                                    <td
                        ...
                        <table align="right" class="wagnistrip-airline-table"
                            style="margin-left: 33px;border-collapse: collapse;border-spacing: 0;width: 40%;float: right;border: 1px solid #f4f4f4;padding: 5px;margin-bottom: 0px;margin-right: 16px;position: relative;left: 54px;">
                            <tbody>
                                <tr>
                                    <td
                                        style="padding:5px 0px 5px 10px;vertical-align:top;font-family:arial;background:#eef4fd;font-weight:bold;line-height:12px;font-size:12px;color:#1951b5">

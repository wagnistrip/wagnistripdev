...
@php
    ...
    $cvalue = $conversion_Rate['value'];
    $cvalue = round($cvalue , 3);

    $icon =  "<i class='fa fa-inr'></i>";
    if(!empty($currency[0])){
        $icon = !empty(__('common.'.$currency[0])) ? __('common.'.$currency[0]) : '$';
    }
@endphp

    <section class="bgcolor pt-6p pb-20 searchpagebanner">
        <div class="searchCardBanner">@include('layouts.searchcard')</div>
    </section>
    
    <section >
        <div class="container">
            <div class="row">
                <div class="col-sm-3 pt-20 pr-0">
                    <div class="boxunder " >
                            <div>
                        ...
                        <div class="ranjepp">
                            ...
                            <div id="Airline" class="collapse show">
                                ...
                                {{-- <div class="padding-10">
                                    ...
                                    <span class="float-right">{!! !empty($icon) ? $icon : '' !!} 20029</span>
                                </div> --}}
                    ...
                    {{-- <div class="" > --}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="float-right ranjepp">
                                                    <form action="{{ route('galileo-pricing') }}" method="POST">
                                                        ...
                                                        <span class="fontsize-22">{!!  $icon !!} 
                                                        @if($isAgent)
                                                        <span class="TotalFare product-card" data-price1="{{ ceil(($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge)*$cvalue) }}">
                                                            {{ ceil(($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $charge)*$cvalue) }}
                                                        </span>
                                                        @else
                                                        <span class="TotalFare product-card" data-price1="{{ ceil(($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'])*$cvalue) }}">
                                                            {{ ceil(($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'])*$cvalue) }}
                                                        </span>
                                                        @endif
                                                        </span>
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tbody class="onwfntrespons-11"> 
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">{!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']*$cvalue) }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right"> {!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalTax']*$cvalue) }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                    <td class="text-right"> {!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare']*$cvalue) }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="tab-pane container fade"
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tbody class="onwfntrespons-11">
                                                                ...
                                                                <tr>
                                                                    <td class="onwfnt-11">Cancel Before 4 hours of departure time.</td>
                                                                    <td> As Per Airline Policy</td>
                                                                    <td>{!! !empty($icon) ? $icon : '' !!} {{ceil(500*$cvalue)}}</td>
                                                                </tr>
                                            ...
                                            <div class="col-6 col-md-6 col-sm-6">
                                                <div class="float-right ranjepp">
                                                    <form action="{{ route('galileo-pricing') }}" method="POST">
                                                        ...
                                                        @else
                                                        <span class="TotalFare product-card" data-price1="{{ ceil(((float)$itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'])*$cvalue) }}">
                                                            {{ ceil(($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'])*$cvalue) }}
                                                        </span>
                                                        @endif
                                                        </span>
                        ...
                        @foreach ($onewaysGroupOfFlights as $rowkey => $flightResults)
                            ...
                            @if (is_array($flightResults->flightDetails) == true && isset($flightResults->flightDetails[2]) && !isset($flightResults->flightDetails[3]))
                                ...
                                @endphp
                                <div class="cardlist take airline_hide stops_hide 2-Stop {{ $flightResults->flightDetails[0]->flightInformation->companyId->operatingCarrier. ' ' .$flightResults->flightDetails[1]->flightInformation->location[0]->locationId}}" data-price1="{{ ceil($itineraries['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare']*$cvalue) }}">
                                    {{-- <div class="grid-item" > --}}
                                    <div class="boxunder grid-item takingoff">
                                        <div class="row">
                                            <div class="col-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="col-6 col-md-6 col-sm-6">
                                                <div class="float-right ranjepp">
                                                    <form action="{{ route('flight-review') }}" method="POST">
                                                        ...
                                                        <span class="fontsize-22">{!! !empty($icon) ? $icon : '' !!}
                                                        @if($isAgent)
                                                        <span class="TotalFare product-card" data-price1="{{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount + $charge)*$cvalue) }}">
                                                            {{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount + $charge)*$cvalue)  }}
                                                        </span>
                                                        @else
                                                        <span class="TotalFare product-card" data-price1="{{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount)*$cvalue) }}">
                                                            {{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount - $paxFareDetails->paxFareDetail->totalTaxAmount)*$cvalue) }}
                                                        </span>
                                                        @endif
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tbody class="onwfntrespons-11">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">{!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil(($totalFareAmount - $totalTaxAmount)*$cvalue) }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="onwfnt-11">Total (Base Fare)</td>
                                                                    <td class="text-right"> {!! !empty($icon) ? $icon : '' !!}
                                                                ...
                                                                <tr>
                                                                    <td class="onwfnt-11">Total Tax +</td>
                                                                    <td class="text-right">{!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil($totalTaxAmount*$cvalue) }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                    <td class="text-right"> {!! !empty($icon) ? $icon : '' !!}
                                                                        {{ ceil($totalFareAmount*$cvalue) }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <div class="float-right ranjepp">
                                                    <form action="{{ route('flight-review') }}" method="POST">
                                                        ...
                                                        <span class="fontsize-22">{!! !empty($icon) ? $icon : '' !!}
                                                            ...
                                                            @else
                                                            <span class="TotalFare product-card" data-price1="{{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount - $totalTaxAmount)*$cvalue) }}">
                                                                {{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount - $totalTaxAmount)*$cvalue) }}
                                                            </span>
                                                            @endif
                                                            </span>
                                        ...
                                        <div id="details{{ $rowkey }}" class="collapse">
                                            <div class="container">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#Details{{ $rowkey }}"> Fare Details </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#Baggage{{ $rowkey }}">Baggage Information </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#Cancellation{{ $rowkey }}"> Cancellation Rules </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="float-right ranjepp">
                                                    <form action="{{ route('flight-review') }}" method="POST">
                                                        ...
                                                        <span class="fontsize-22">{!! !empty($icon) ? $icon : '' !!}
                                                            ...
                                                            @else
                                                                <span class="TotalFare product-card" data-price1="{{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount - $paxFareDetails->paxFareDetail->totalTaxAmount)*$cvalue)}}">
                                                                    {{ ceil(($paxFareDetails->paxFareDetail->totalFareAmount - $paxFareDetails->paxFareDetail->totalTaxAmount)*$cvalue) }}
                                                                </span>
                                                            @endif
                                                        </span>
                                        ...
                                        <div id="details{{ $rowkey }}" class="collapse">
                                            <div class="container">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab"
                                                            href="#Information{{ $rowkey }}"> Flight Information </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#Details{{ $rowkey }}"> Fare Details </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#Baggage{{ $rowkey }}">Baggage Information </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#Cancellation{{ $rowkey }}">Cancellation Rules </a>
                                                    </li>
                                                </ul>
...
function fetchAirlineCode(iddata, divs) {
  fetch("https://www.flight.wagnistrip.com/api/airlinecode?search=" + iddata)
...
function get_conversion(price){
    var cvalue = "{{$cvalue}}";
    var value =  price*cvalue;
...
arrfilterline.forEach(element => {
        airlineLoop = '<div class="padding-10 input_row12">' + '<span class="span_input"><input type="checkbox" class="form-check-input" value="'+ element.code+ '">'+'<img src="{{ asset('assets/images/flight/') }}/'+element.code+'.png" width="20px" height="20px" alt="">' + deskiata[element.name]+ ' </span>' + '<span class="float-right">{!!$icon!!} '+ get_conversion(element.airFare) + ' </span>' + '</div>';
    ...
    '<span class="float-right">{!! $icon !!} '+ get_conversion(element.airFare) + ' </span>' +
    '</div>';
...
arrfilterStop.forEach(element => {
   ...
   ' <span class="float-right">{!! $icon !!} '+ get_conversion(element.airFare) + ' </span>' + '</div>';

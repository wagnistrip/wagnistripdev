                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    @endphp
                                        ...
                                        {!! $icon !!}
                                        {{ ceil($monetaryDetails*$cvalue) . ')' }}
                                    </span>
                                
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                        {{ ceil(((int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails)*$cvalue) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                        {{ (int) ceil(($newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails+$Charge - (int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails)*$cvalue) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                        ...
                        <div class="boxunder p-2">
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        {!! $icon !!}
                                        {{ ceil($monetaryDetails_1*$cvalue)  }}
                                    </span>
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                        {{ (int) ceil(($newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_1)*$cvalue) }}</span>
                                </div>
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        {!! $icon !!}
                                        {{ ceil($monetaryDetails_2*$cvalue) . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                        {{ ceil(((int) $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_2)*$cvalue) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    ...
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                    <?php
                                    $tot_cus = array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails_1+$Charge, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $otherMonetaryDetails_2+$Charge]) - array_sum([(int) $newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_1, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_2]);
                                    ?>
                            ...
                            <div class="ranjepp">
                                ...
                                <div class="p-1">
                                    <span class="font-14">
                                        ...
                                        {!! $icon !!}
                                        {{ ceil($monetaryDetails_3*$cvalue) . ')' }}
                                    </span>
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                        {{ ceil(((int) $newFare[2]->numberOfPax->segmentControlDetails->numberOfUnits * (int) $monetaryDetails_3)*$cvalue) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">
                                ...
                                <div id="price" class="collapse show">
                                    ...
                                    <span class="float-right fontsize-17">{!! $icon !!}
                                     <?php
                                     $getTot_sum = getTotalTaxes($newFare[0]->numberOfPax->segmentControlDetails->numberOfUnits, $newFare[1]->numberOfPax->segmentControlDetails->numberOfUnits, $newFare[2]->numberOfPax->segmentControlDetails->numberOfUnits, (int)$otherMonetaryDetails_1+$Charge, (int)$otherMonetaryDetails_2+$Charge, (int)$otherMonetaryDetails_3, (int)$monetaryDetails_1, (int)$monetaryDetails_2, $monetaryDetails_3)
                                     ?>
                                        {{ ceil($getTot_sum*$cvalue) }}</span>
                                </div>
                            </div>
                            <div class="border-bottom"></div>
                            <div class="ranjepp">

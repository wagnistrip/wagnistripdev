            ...
            <div class="row" >
                ...
                <div class="col-sm-5 isotope-grid" id="flightMainCard" >
                    ...
                    @foreach ($availabilityOutbounds['Availibilities'][0]['Availibility'] as $AvailOutKey => $itinerariesOutbound)
                        ...
                        <div class="pb-10 airline_hide stops_hide 1-Stop {{ $itinerariesOutbound['Itineraries']['Itinerary'][0]['AirLine']['Code'] }}" data-price1="{{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}">
                            ...
                            {{-- <div class="col-sm-2 mt-3"> --}}
                                ...
                                @if($isAgent)
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ convarter(($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge) , $cvalue) }}"> {!! $icon !!}
                                            {{ converter(($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge) , $cvalue) }}</span>
                                    </div>
                                @else
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ ceil($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']*$cvalue) }}"> {!! $icon !!}
                                            {{ converter(($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']) , $cvalue) }}</span>
                                    </div>
                                @endif
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right ">{!! $icon !!}
                                                                    {{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] , $cvalue) }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right"> {!! $icon !!}
                                                                    {{ converter(($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalTax'] +  $Charge) , $cvalue)  }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                <td class="text-right"> {!! $icon !!}
                                                                    {{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> {!! $icon !!} {{converter(500 , $cvalue)}}</td>
                                                            </tr>
                    ...
                    @elseif (isset($itinerariesOutbound['Itineraries']['Itinerary'][0]) &&
                        ...
                        <div class="pb-10 airline_hide stops_hide Non-Stop {{ $itinerariesOutbound['Itineraries']['Itinerary'][0]['AirLine']['Code'] }}" data-price1="{{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}">
                     ...
                     {{--<div class="col-sm-2 mt-3 ob-dur-loc"> --}}
                            ...
                            {{-- <div class="col-sm-2 mt-3"> --}}
                                     ...
                                     @if($isAgent)
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge , $cvalue) }}"> {!! $icon !!}
                                            {{ converter(($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge)) , $cvalue }}</span>
                                    </div>
                                    @else
                                    <div class="col-2 col-md-3 col-sm-3 mt-3">
                                        <span class="fontsize-22 ob-fare" data-price1="{{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare']*$cvalue , $cvalue) }}"> {!! $icon !!}
                                            {{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] , $cvalue) }}</span>
                                    </div>
                                    @endif
                                     {{--    <div class="col-sm-1 mt-3"> --}}
                    ...
                    @foreach ($roundtripOutboundsGroupOfFlights as $outBoundkey => $outBoundFlights)
                        ...
                        @elseif (is_array($outBoundFlights->flightDetails) == true && isset($outBoundFlights->flightDetails[2]) && !isset($outBoundFlights->flightDetails[3]))
                            ...
                            <div class="pb-10 airline_hide stops_hide 2-Stop {{ $outBoundFlights->flightDetails[0]->flightInformation->companyId->operatingCarrier }}" data-price1="{{ converter($itinerariesOutbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}">
                                            ...
                                            @foreach ($roundtripOutboundsRecommendation as $recommendation)
                                                ...
                                                @foreach ($segmentFlightRefs as $segmentFlightRef)
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $outBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                        @if($isAgent)
                                                        <span class="fontsize-22 ob-fare" data-price1="{{ converter(($paxFareProduct->paxFareDetail->totalFareAmount + $Charge) , $cvalue) }}"> {!! $icon !!}
                                                            {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount + $Charge) , $cvalue) }}
                                                        @else
                                                        <span class="fontsize-22 ob-fare" data-price1="{{ ceil(($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount)*$cvalue) }}"> {!! $icon !!}
                                                            {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount) , $cvalue) }}
                                                        @endif
                                                            @php
                                                                $totalFareAmount = converter($paxFareProduct->paxFareDetail->totalFareAmount , $cvalue);
                                                                $totalTaxAmount = converter($paxFareProduct->paxFareDetail->totalTaxAmount , $cvalue);
                                                            @endphp
                                                        </span>
                                                    @endif
                                                @endforeach
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="onwfnt-11">Total Tax +</td>
                                                                <td class="text-right"> {!! $icon !!}
                                                                    {{ ($totalTaxAmount  +  ceil($Charge*$cvalue)) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                <td class="text-right"> {!! $icon !!}
                                                    ...
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $outBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                            ...
                                                            <span class="fontsize-22 ob-fare" data-price1="{{ converter($paxFareProduct->paxFareDetail->totalFareAmount + $Charge , $cvalue) }}"> {!! $icon !!}
                                                                {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount + $Charge) , $cvalue) }}
                                                            @else
                                                            <span class="fontsize-22 ob-fare" data-price1="{{ converter($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount , $cvalue)}}"> {!! $icon !!}
                                                                {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount) , $cvalue)}}
                                                            @endif
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="onwfnt-11">Total Tax +</td>
                                                                <td class="text-right"> {!! $icon !!}
                                                                    {{ ($totalTaxAmount +  converter($Charge , $cvalue)) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                <td class="text-right"> {!! $icon !!}
                        ...
                        @if (isset($itinerariesInbound['Itineraries']['Itinerary'][0]) && isset($itinerariesInbound['Itineraries']['Itinerary'][1]) && !isset($itinerariesInbound['Itineraries']['Itinerary'][2]))
                         ...
                         @php
                          ...
                          @endphp
                            ...
                            <div class="pb-10 airline_hide stops_hide secound-list 1-Stop {{ $itinerariesInbound['Itineraries']['Itinerary'][0]['AirLine']['Code'] }}" data-price1="{{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}">
                                ...
                                {{--    <div class="col-sm-2 ib-flight"> --}}
                                    ...
                                    {{--    <div class="col-sm-2 mt-3 ib-dur-loc"> col-3 col-md-2 col-sm-2 mt-3 ob-dur-loc ////col-sm-2 mt-3 ib-dur-loc/////  col-3 col-md-2 col-sm-2 mt-3 ob-dur-loc --}}
                                       ...
                                       <div class="col-2 col-md-2 col-sm-2 mt-3">
                                        ...
                                        @if($isAgent)
                                           <div class="col-2 col-md-3 col-sm-3 mt-3">
                                                <span class="fontsize-22 ib-fare" data-price2="{{ converter(($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge) , $cvalue)}}"> {!! $icon !!}
                                                    {{ converter(($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] + $Charge) , $cvalue) }}</span>
                                            </div>
                                        @else
                                           <div class="col-2 col-md-3 col-sm-3 mt-3">
                                                <span class="fontsize-22 ib-fare" data-price2="{{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] , $cvalue) }}"> {!! $icon !!}
                                                    {{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] , $cvalue) }}</span>
                                            </div>
                                        @endif
                                        {{--    <div class="col-sm-1 mt-3"> --}}
                                 <div class="col-1 col-md-1 col-sm-1 mt-3">
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="onwfnt-11">1 Adult</td>
                                                                    <td class="text-right"> {!! $icon !!}
                                                                        {{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['BaseFare'] , $cvalue) }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="onwfnt-11">Total (Base Fare)</td>
                                                                ...
                                                                <tr>
                                                                    <td class="onwfnt-11">Total Tax +</td>
                                                                    <td class="text-right"> {!! $icon !!}
                                                                        {{ converter(($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalTax'] +  $Charge) , $cvalue) }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="onwfnt-11">Total (Fee & Surcharge)</td>
                                                                    <td class="text-right"> {!! $icon !!}
                                                                        {{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                        ...
                        @elseif (isset($itinerariesInbound['Itineraries']['Itinerary'][0]) &&
                            ...
                            !isset($itinerariesInbound['Itineraries']['Itinerary'][2]))
                              ...
                              @endphp
                                   ...
                                   <div class="pb-10 airline_hide stops_hide secound-list Non-Stop {{ $itinerariesInbound['Itineraries']['Itinerary'][0]['AirLine']['Code'] }}" data-price1="{{ converter($itinerariesInbound['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['TotalFare'] , $cvalue) }}">
                                            ...
                                            @foreach ($roundtripInboundsRecommendation as $recommendation)
                                                ...
                                                @foreach ($segmentFlightRefs as $segmentFlightRef)
                                                    @if ($segmentFlightRef->referencingDetail[0]->refNumber == $inBoundFlights->propFlightGrDetail->flightProposal[0]->ref)
                                                        ...
                                                        @endphp
                                                        @if($isAgent)
                                                        <span class="fontsize-22 ib-fare" data-price2="{{ converter(($paxFareProduct->paxFareDetail->totalFareAmount + $Charge) , $cvalue) }}"> {!! $icon !!}
                                                            {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount + $Charge) , $cvalue)  }}
                                                        @else
                                                        <span class="fontsize-22 ib-fare" data-price2="{{ converter(($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount) , $cvalue) }}"> {!! $icon !!}
                                                            {{ converter(($paxFareProduct->paxFareDetail->totalFareAmount - $paxFareProduct->paxFareDetail->totalTaxAmount) , $cvalue)}}
                                                        @endif
                                                            @php
                                                                $totalFareAmount = converter($paxFareProduct->paxFareDetail->totalFareAmount , $cvalue);
...
<div class="loaderr" >
  <div class="loading">
    <img src="{{url('assets/images/loader.gif')}}" alt="" srcset="" loading="lazy">
...
// =========================================================
    // price range slider 1  
        // new \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        var minp_text = $('.ob-fare').first().text();
        var maxp_text  = $('.ob-fare').first().text();
        var rem  = minp_text.replace('{!! $icon !!}'  , ''); 

        var minPrice = parseInt(rem.trim());
        var maxPrice = parseInt(rem.trim());
        // var minPrice = parseInt($('.ob-fare').first().text());
        // var maxPrice = parseInt($('.ob-fare').first().text());
            $('.ob-fare').each(function() {
                var text_cus = $(this).text();
                text_cus = text_cus.replace('{!! $icon !!}' , '');
                text_cus  = text_cus.trim();
                                
                // var price = parseInt($(this).text());
                var price = parseInt(text_cus);
            ...
            $('#minprice1').on('input', function() {
                ...
                var mininput = $('#minprice1').val();
                 var minPrice = mininput;
            ...
            function filterAirlineHide(minPrice, maxPrice) {
                $('#flightMainCard .airline_hide').each(function() {
                    ...
                    var faretext = $(this).find('.ob-fare').text();
                    faretext = faretext.replace('{!! $icon !!}'  , '');
            ...
            // slider 2 new
            var minprice_text = $('.ib-fare').first().text();
             maxprice_text = $('.ib-fare').first().text();
            
             minprice_text = minprice_text.replace('{!! $icon !!}' , '');
             minprice_text = minprice_text.trim();
            ...
            // var maxPrice = parseInt($('.ib-fare').first().text());
                $('.ib-fare').each(function() {
                    ...
                    var price_text  =$(this).text();
                     price_text = price_text.replace('{!! $icon !!}' , '');
                ...
                $('#minprice2').on('input', function() {
                    ...
                    var minprice_text = $('#minprice2').val();
                     minprice_text = minprice_text.replace('{!! $icon !!}' , '');
                     minprice_text  = minprice_text.trim();
                    minprice_text = parseInt(minprice_text);
                ...
                function filterAirlineHides(minPrice, maxPrice) {
                    $('#flightMainCard2 .airline_hide').each(function() {
                        // var fare = parseInt($(this).find('.ib-fare').text());
                            var fare_text = $(this).find('.ib-fare').text();
                            fare_text = fare_text.replace('{!! $icon !!}' , '');
